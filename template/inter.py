...
for i in range(num_tests):
  ...
  t_sol.start()
  t_judge.start()
  # Add a timeout of 10 seconds for t_sol.join()
  t_sol.join(timeout=5)
  t_judge.join()

  # Print an empty line to handle the case when stderr doesn't print EOL.
  print()
  if t_judge.return_code == 0 and t_sol.return_code == 0 and not t_sol.error_message and not t_judge.error_message:
    continue
